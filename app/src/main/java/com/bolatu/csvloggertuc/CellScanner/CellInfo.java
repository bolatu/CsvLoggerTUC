...
public class CellInfo {
    ...
    private static final String LOG_TAG = "CellInfo";
...
//    }
    ...
    public void setGsmCellInfo(int mcc, int mnc, int lac, int cid, int asu, int dbm) {
        mCellRadio = CELL_RADIO_GSM;
    ...
    public void setWcdmaCellInfo(int mcc, int mnc, int lac, int cid, int psc, int asu, int dbm) {
     ...
     */
    public void setLteCellInfo(int mcc, int mnc, int ci, int psc, int lac, int asu, int ta, int dbm) {
